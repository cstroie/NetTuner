...
#define DEFAULT_LED_PIN           2  ///< ESP32 internal LED pin (shared with camera)
...
#define DEFAULT_DISPLAY_SDA      14  ///< OLED display SDA pin (changed from default to avoid camera pins)
#define DEFAULT_DISPLAY_SCL      15  ///< OLED display SCL pin (changed from default to avoid camera pins)
